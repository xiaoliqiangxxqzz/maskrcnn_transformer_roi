...
_C.INPUT.MIN_SIZE_TRAIN = (750,)  # (800,)
# Maximum size of the side of the image during training
_C.INPUT.MAX_SIZE_TRAIN = 1333
# Size of the smallest side of the image during testing
_C.INPUT.MIN_SIZE_TEST = 750
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 1+5
...
_C.MODEL.RETINANET.NUM_CLASSES = 1+5
...
# Misc options
# ---------------------------------------------------------------------------- #
# _C.OUTPUT_DIR = "output_res50_dhaze_gcan_5_addtest0.6"
_C.OUTPUT_DIR = "output_after_center20_nosig"
